...
## 1)
<img src="../docs/recursos/imgs/trsf_nom_1.jpeg" alt="Ejercico 1" width="420">
...
<img src="../docs/recursos/imgs/rotation_y.png" alt="Rotation Y" width="420">

<img src="../docs/recursos/imgs/rotation_x.png" alt="Rotation X" width="420">
...
<img src="../docs/recursos/imgs/matrix_mul.png" alt="matrix multiplication" width="420">
...
<img src="../docs/recursos/imgs/matrix_res.png" alt="multiplication result" width="420">

Finally we just need to simplify our result and we get the rotation matrix **R** whit all its axis components:

<img src="../docs/recursos/imgs/matrix_sim.png" alt="rotation matrix R" width="420">
